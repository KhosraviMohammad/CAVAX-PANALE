...
import { selectIsUserFormOpen } from "@/store/selectors";
...
export const UserFormDialog: React.FC = () => {
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
      <DialogTitle sx={{ fontWeight: "bold" }}>افزودن کاربر جدید</DialogTitle>
      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} noValidate>
        ...
        <DialogActions sx={{ p: 2 }}>
          ...
          <Button type="submit" variant="contained" color="primary" disabled={isLoading}>
            {isLoading ? <CircularProgress size={24} color="inherit" /> : "ثبت کاربر"}
          </Button>
        </DialogActions>
      </form>
    </Dialog>
